# Responses, strings, text for module youtube.childes.search
...
inline_data = get_child_modules_settings_inline_data(
    module_path=Path("D:/ProgrammingProjects/Python/Bot/Project/BOT_PROJECT/func_store_botV1.4/src/app/bot/modules/youtube/childes/search/childes"),
    root_package="app.bot.modules.youtube.childes.search.childes"
)
