...
from app.bot.modules.find_image.settings import settings
from app.bot.modules.find_image.response import get_keyboards_menu_buttons
...
async def find_image(message: Message, bot: Bot) -> None:
    """
    Главный обработчик для модуля find_image.
