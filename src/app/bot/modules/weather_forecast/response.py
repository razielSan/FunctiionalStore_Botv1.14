# Responses, strings, text for module weather_forecast
...
inline_data = get_child_modules_settings_inline_data(
    module_path=Path("D:/ProgrammingProjects/Python/Bot/Project/BOT_PROJECT/func_store_botV1.4/src/app/bot/modules/weather_forecast/childes"),
    root_package="app.bot.modules.weather_forecast.childes"
)
