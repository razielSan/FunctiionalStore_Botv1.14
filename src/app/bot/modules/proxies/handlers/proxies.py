...
from app.bot.modules.proxies.settings import settings
from app.bot.modules.proxies.response import get_keyboards_menu_buttons
...
async def proxies(message: Message, bot: Bot) -> None:
    """
    Главный обработчик для модуля proxies.
