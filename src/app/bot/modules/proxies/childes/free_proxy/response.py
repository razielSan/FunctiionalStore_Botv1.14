# Responses, strings, text for module proxies.childes.free_proxy
...
inline_data = get_child_modules_settings_inline_data(
    module_path=Path("D:/ProgrammingProjects/Python/Bot/Project/BOT_PROJECT/func_store_botV1.4/src/app/bot/modules/proxies/childes/free_proxy/childes"),
    root_package="app.bot.modules.proxies.childes.free_proxy.childes"
)
